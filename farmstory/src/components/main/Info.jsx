export default function Info(){
    return(
      <>
          <div className="info">
                <div>
                    <img src="./images/main_sub2_cs_tit.png" className="tit" alt="고객센터 안내"/>
                    <div className="tel">
                ...
                <div>
                    <img src="./images/main_sub2_account_tit.png" className="tit" alt="계좌안내"/>
                    <p className="account">
                ...
                <div>
                    <img src="./images/main_sub2_notice_tit.png" className="tit" alt="공지사항"/>                    
                    <table className="notice" border="0">
                        <tr>
                            <td>·</td>
                            <td><a href="#">안녕하세요. 홈페이지 오픈 기념 이벤트를 진행합니다.</a></td>
                            <td>20-12-22</td>
                        </tr>
                        <tr>
                            <td>·</td>
